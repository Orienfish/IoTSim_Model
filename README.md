...
In general, a power model is represented with a linear combination of the input parameters and coefficients: iiei+c where c is the intercept which is highly related to the static power.
