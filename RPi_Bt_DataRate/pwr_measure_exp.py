# For single time power measurement in a series
# Store the measured data in ./bt_rate_data/
# Usage: python pwr_measure_exp.py 600 300
# 600 is the version, 300 means running for 300 secs
import sys
import os
