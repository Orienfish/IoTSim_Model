...
# Usage: python pwr_measure_exp.py pkt_1200 300
# pkt_1200 is the version, running for 300 seconds
import sys
import os
...
if version is not None:
	filename = "./udp_data/pwr_%s.txt" %version
else:
	filename = "./udp_date/pwr_" + datetime.datetime.now().strftime("%H%M%S%m%d%Y") + \
		".txt"
f = open(filename, "w")
